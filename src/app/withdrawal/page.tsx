    ...
    <div className="max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1">
          Withdraw your earnings to your Easypaisa, JazzCash, SadaPay, OPay, or Bank account.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <WithdrawalForm settings={settings} />
        </div>
        <div className="space-y-6">
          <div className="p-6 rounded-3xl bg-gradient-to-b from-[#132a4e] to-[#0f213d] border border-[#00D4FF]/30 shadow-xl space-y-4">
            ...
            <ul className="list-disc list-inside text-xs text-slate-300 space-y-1">
              <li>Minimum withdrawal: <span className="text-[#FFD700] font-bold">30 PKR</span></li>
